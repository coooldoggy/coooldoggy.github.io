...
<p>심지어 ArrayList로 구현하는게 아닌 Array로 구현해야 해서 값들의 예외 상황을 모두 예측하여 index 계산을 해야했다....</p>

<p>그렇게 검색을 계속하던 중 어려워하는 것을 눈치채셨는지 먼저 ArrayList로 구현한 뒤 Array로 구현해보라고 하셨다.</p>
...
![my alternate text](/assets/list1.png)
...
![my alternate text](/assets/list2.png)
...
![my alternate text](/assets/list3.png)

<p>index 4의 값은 우리가 찾으려던 값인 5이므로 이 함수가 끝나게 된다.</p>

<p>아래의 코드를 보며 생각해보자.</p>
