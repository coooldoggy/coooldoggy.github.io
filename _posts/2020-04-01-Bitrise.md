...
![스크린샷 2020-04-01 오전 8.43.51](/assets/스크린샷 2020-04-01 오전 8.43.51.png)

Github repository를 선택하면 access key를 생성할 것인지 물어본다.

auoto add SSH key 를 선택하면 알아서 key를 만들어 연결해준다.

![스크린샷 2020-04-01 오전 8.45.12](/assets/스크린샷 2020-04-01 오전 8.45.12.png)

이제 branch를 선택한다.

![스크린샷 2020-04-01 오전 8.45.40](/assets/스크린샷 2020-04-01 오전 8.45.40.png)
